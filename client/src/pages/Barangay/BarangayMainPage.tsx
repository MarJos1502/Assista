...
import AddBarangayForm from "./components/AddBarangayForm";
...
const BarangayMainPage = () => {
  ...
  useEffect(() => {
    document.title = "Barangay Main Page";
  }, []);
    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="col-span-2 md:col-span-1">
          <AddBarangayForm
            onBarangayAdded={showToastMessage}
            refreshKey={handleRefresh}
          />
        </div>
        <div className="col-span-2 md:col-span-1">
          <BarangayList refreshKey={refresh} />
        </div>
      </div>
    </>
  );
